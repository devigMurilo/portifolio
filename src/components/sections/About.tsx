    ...
    <section id="sobre" className="relative px-4 py-28 sm:px-6">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid items-start gap-8 lg:grid-cols-[1fr_1.25fr]">
                ...
                <SpotlightCard className="h-full p-7">
                  <div className="flex items-center gap-4">
                    <div className="relative">
                      <div className="absolute -inset-1 rounded-2xl bg-linear-to-br from-accent-500 to-steel-400 opacity-60 blur-md" />
                      <img
                        src={profile.avatar}
                        alt={profile.name}
                        loading="lazy"
          ...
          <Parallax speed={-26} className="flex flex-col justify-center gap-7">

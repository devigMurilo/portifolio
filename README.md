...
Internet no IFRN campus São Paulo do Potengi. O conteúdo (bio, stack e projetos) vem do perfil e dos
...
[`liquid-glass-button.tsx`](src/components/ui/liquid-glass-button.tsx) — 14 instâncias: as duas do
herói, os cinco filtros de projeto, "Ver todos os repositórios", as duas de contato, "voltar ao topo"
...
mesmo `id` aparece 14 vezes no DOM (funciona, mas é HTML inválido — dá para içar o filtro uma vez em
